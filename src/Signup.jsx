...
//         <h2 className="text-2xl font-bold text-center mb-6 underline text-purple-700">Sign Up</h2>
...
function Signup() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-purple-600 to-blue-800 m-0">
      <h1 className="text-4xl font-bold text-white mb-6 mx-8">Monthly Expense Tracker</h1>
